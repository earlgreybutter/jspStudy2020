...
<tr height="30">
	...
	<input type="button" value="글수정" onclick="document.location.href='/boardMvc2Ora/updateForm.do?num=${article.num}&pageNum=${pageNum}'">
	&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="button" value="글삭제" onclick="document.location.href='/boardMvc2Ora/deleteForm.do?num=${article.num}&pageNum=${pageNum}'">
	&nbsp;&nbsp;&nbsp;&nbsp;
