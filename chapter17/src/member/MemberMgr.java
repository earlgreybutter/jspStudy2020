...
public class MemberMgr {
	...
	// 회원정보보기
	public MemberBean getMember/*memView*/(String id) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	public boolean updateMember(MemberBean bean) {
		...
		try {
			con = pool.getConnection();
			String sql = "update tblmember set pwd=?, name=?, gender=?, birthday=?, email=?, zipcode=?, address=?, hobby=?, job=? "
					+ "where id =?";
			pstmt = con.prepareStatement(sql);
